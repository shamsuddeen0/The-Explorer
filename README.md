[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=31&duration=4500&pause=1000&color=164B63&multiline=true&width=500&height=100&lines=My+Cyber+Security+Journey;Learning+Together;Roadmap+for+Beginners)](https://git.io/typing-svg)
...
## 🚀 Overview
Unlike a static textbook, this is a **living document**. It tracks my progress from the fundamentals to advanced topics. If you are a student, a career switcher, or a tech enthusiast, you can use this repo to see exactly what resources I used to learn specific topics.
...
- **[Linux-Essentials](linux/cheat-sheets/linux)**: Command line mastery, permissions, and scripting.
...
## 📜 License
This project is open-source and available to anyone who wants to learn.
